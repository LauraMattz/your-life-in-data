  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="text-center mb-12">
        <h1 className="text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-purple-400 via-pink-400 to-purple-500 bg-clip-text text-transparent">
          Olá, {userProfile.name}! 👋
        </h1>
        <p className="text-lg md:text-xl text-purple-100 max-w-3xl mx-auto mb-6 leading-relaxed">
          Seu dashboard pessoal da vida — Uma calculadora brutalmente honesta de como você vive sua existência
        </p>
        <div className="bg-gradient-to-r from-green-600/20 to-emerald-600/20 border border-green-500/30 rounded-xl p-4 max-w-md mx-auto backdrop-blur-sm">
